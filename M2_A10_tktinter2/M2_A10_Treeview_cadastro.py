...
texto_nome = ttk.Label(Janela,text="Nome")
entrada_nome = ttk.Entry(Janela)
texto_email = ttk.Label(Janela,text="Email")
entrada_email = ttk.Entry(Janela)

botao_cadastrar = ttk.Button(Janela,text="Cadastrar",command=None) # PAREI NO MINUTO 34:51 do video.
